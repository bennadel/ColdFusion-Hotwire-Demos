	...
	<cfoutput>
		...
		<body>
			...
			<p>
				...
				<a href="about.htm" <cfif ( attributes.section == "about" )>style="font-weight: bold ;"</cfif>>About</a> -
				<a href="upgrade.htm" <cfif ( attributes.section == "upgrade" )>style="font-weight: bold ;"</cfif>>Upgrade</a>
			</p>
