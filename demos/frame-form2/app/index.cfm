...
<cfmodule template="./tags/page.cfm">
	<cfoutput>
		...
		<!---
			This Turbo Frame is loaded after the page loads and will inline the create-
			note form. The static contents of the form will be rendered as a fallback
			while the remote template is being loaded.
			--
